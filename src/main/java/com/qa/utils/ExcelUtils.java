...
public class ExcelUtils {
	...
	public static void setCellData(String file, String Result, int RowNum, int ColNum) {
		...
		try {
			...
			FileOutputStream fileOut = new FileOutputStream(Constants.PATH_TEST_DATA + file);
